...
require (
	...
	github.com/gofiber/template/jet/v3 v3.0.7
...
require (
	...
	github.com/elmyrockers/go-mimebuilder v0.0.0-20260714212952-26a368c58f59 // indirect
	github.com/elmyrockers/go-sesmailer v0.0.0-20260715102943-b0ba73742f52 // indirect
